import { ActivityIndicator, View, StyleSheet, Animated, Text, Dimensions, Image, TextInput, TouchableOpacity } from "react-native";
        ...
        <View style={{flex:1, width:"100%", height:"100%", alignItems:"center"}}> 
            ...
            {showPhase2 &&
                <Animated.View style={{flex:1, opacity: fadeInPhase2Animation, alignItems:"center", marginTop:50, transform:[{translateY:translateYPhase2WholeAnimation}]}}>
                    <Text style={{fontSize:18}}>There seems to be <Text style={{fontSize:18, color:"red"}}>spaces</Text> in our link...</Text>
                    <Text style={{fontSize:18}}>It might be <Text style={{fontSize:18, color:"red"}}>ascii codes!</Text></Text>
                    <Text style={{fontSize:18}}>Let's try to convert then!</Text>
